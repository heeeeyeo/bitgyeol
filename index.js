...
(function () {
    // constants
    var 영어 = [
        "#0b6db7","#45436c","#f15b5b","#b82647","#683235","#e2a6b4","#f6cf7a","#f9d537","#9a6b31","#db4e9c",
        "#6d1b43","#9ed6c0","#ffffff","#1d1e23","#a4aaa7","#5ac6d0","#ea8474","#d6b038","#616264","#f6cf7a",
        "#f15b5b","#9ed6c0","#e2a6b4","#616264","#5ac6d0","#ea8474","#a4aaa7","#d6b038","#b9cf50","#417141",
        "#e7e6d2","#d8c8b2","#dde7e7","#84a7d3","#6ab048","#245441","#9390aa","#9c4998","#bea3c9","#6f606e",
        "#f1a55a","#bb9e8b","#9c4998","#6ab048","#e7e6d2","#9390aa","#dde7e7","#b9cf50","#bb9e8b","#6f606e",
        "#bea3c9","#f1a55a"
        ];                         // 33 + 19개
    ...
    Inko.prototype.한글분리 = function (_한글) {
        ...
        if (코드 >= 가 && 코드 <= 힣) {
            ...
            return [영어[초], 영어[중1], 영어[중2], 영어[종1], 영어[종2]];
        } else if (코드 >= ㄱ && 코드 <= ㅣ) {
            if (초성.indexOf(_한글) > -1) {
